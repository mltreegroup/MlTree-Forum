(function(window, document, undefined) {
    ...
    (function(factory) {
        ...
        var defaults = {
            ...
            direction: '', // ltr,rtl
            animation: null,
            template: '<div class="webui-popover mdui-color-white mdui-text-color-black">' +
                '<div class="webui-arrow"></div>' +
                '<div class="webui-popover-inner">' +
                '<a href="#" class="close"></a>' +
                '<h3 class="webui-popover-title"></h3>' +
                '<div class="webui-popover-content mdui-text-color-black"><i class="icon-refresh"></i> <p>&nbsp;</p></div>' +
                '</div>' +
                '</div>',
            backdrop: false,
            dismissible: true,
